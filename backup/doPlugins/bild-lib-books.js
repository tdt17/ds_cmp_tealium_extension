...
//Config
            ...
            if (document.referrer !== '' ) {
                ...
                if (_isSearchView)
                    ...
                    if (_isSocialView) s._articleViewType = 'event25';
                        ...
                        var _isrefbildwwwView = ((window.location.search.indexOf('wtmc=') !=-1 && document.referrer.indexOf('https://trc.taboola.com/bilddedt/') !=-1) || (document.referrer.indexOf('www.bild.de') !=-1 && (window.location.search.indexOf('dtp=') !=-1) ));
                        if (_isrefbildwwwView) s._articleViewType = 'event76';
                            ...
                            var _isrefbildmView = ((window.location.search.indexOf('wtmc=') !=-1 && document.referrer.indexOf('https://trc.taboola.com/bilddemw/') !=-1 ) || (document.referrer.indexOf('m.bild.de') !=-1 && (window.location.search.indexOf('dtp=') !=-1) ))
    ...
    /*
        //From BILD Home
       if((window.location.search.indexOf('wtmc=') !=-1 && document.referrer.indexOf('https://trc.taboola.com/bilddedt/') !=-1) || (document.referrer.indexOf('.bild.de') !=-1 && (window.location.search.indexOf('dtp=') !=-1) )){
            s.events = s.apl(s.events, "event76", ',', 1);
            console.log('event76');
        }
        else if((window.location.search.indexOf('wtmc=') !=-1 && document.referrer.indexOf('https://trc.taboola.com/bilddedt/') !=-1 ) || (document.referrer.indexOf('.bild.de') !=-1 && (window.location.search.indexOf('dtp=') !=-1) )) {
