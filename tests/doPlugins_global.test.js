...
describe('setArticleViewType()', () => {
    ...
    describe('getPageType', () => {
        ...
        it('should get the page type from the data layer: page_type', function () {
            ...
            const result = doPluginsGlobal.setArticleViewType.getPageType();
    ...
    describe('isArticlePage()', () => {
        ...
        it('should be false when page is NOT of type article', () => {
            const result = doPluginsGlobal.setArticleViewType.isArticlePage();
    ...
    describe('isFromSearch()', () => {
        it('should return TRUE if referrer is a search engine', function () {
            ...
            searchEngines.forEach((item) => {
                ...
                const result = doPluginsGlobal.setArticleViewType.isFromSearch();
    ...
    describe('isFromSocial()', () => {
        it('should return TRUE if referrer is a search engine', function () {
            ...
            socialDomains.forEach((item) => {
                window.document.referrer = `https://${item}/any-path`;
                const result = doPluginsGlobal.setArticleViewType.isFromSocial();
                expect(result).toBe(true);
            });
        });
    ...
    describe('isFromInternal()', function () {
        it('should return TRUE if referrer is from the same domain', function () {
            ...
            const result = doPluginsGlobal.setArticleViewType.isFromInternal();
            expect(result).toBe(true);
        });
    ...
    describe('isFromSubdomain()', function () {
        it('should return TRUE if referrer is from a sub-domain', function () {
            ...
            window.document.domain = anyDomain;
            const result = doPluginsGlobal.setArticleViewType.isFromSubdomain();
            expect(result).toBe(true);
        });
    ...
    describe('isFromHome', () => {
        it('should return TRUE if referrer is from homepage of same domain', function () {
            ...
            window.document.domain = anyDomain;
            const result = doPluginsGlobal.setArticleViewType.isFromHome();
            expect(result).toBe(true);
        });
    ...
    describe('isFromTaboola()', () => {
        ...
        beforeEach(() => {
            getTrackingValueMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'getTrackingValue');
        });
        ...
        it('should return TRUE if referrer is from Taboola context', function () {
            ...
            const result = doPluginsGlobal.setArticleViewType.isFromTaboola();
            expect(result).toBe(true);
        });
    ...
    describe('getViewTypeByReferrer()', () => {
        ...
        beforeEach(() => {
            isFromSearchMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'isFromSearch').mockReturnValue(false);
            isFromSocialMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'isFromSocial').mockReturnValue(false);
            isFromInternalMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'isFromInternal').mockReturnValue(false);
            isFromHomeMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'isFromHome').mockReturnValue(false);
            isFromTaboolaMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'isFromTaboola').mockReturnValue(false);
        });
        ...
        it('should return the right event name if referrer is of type: Other External', () => {
            const result = doPluginsGlobal.setArticleViewType.getViewTypeByReferrer();
        ...
        it('should return the right event name if referrer is of type: Taboola', () => {
            ...
            let result = doPluginsGlobal.setArticleViewType.getViewTypeByReferrer();
            expect(result).toBe('event102');

            isFromInternalMock.mockReturnValue(false);
            isFromHomeMock.mockReturnValue(true);
            isFromTaboolaMock.mockReturnValue(true);
            result = doPluginsGlobal.setArticleViewType.getViewTypeByReferrer();
    ...
    describe('getTrackingValue', () => {
        ...
        it('should return the value of the URL query param: cid', () => {
            ...
            const result = doPluginsGlobal.setArticleViewType.getTrackingValue();
    ...
    describe('getViewTypeByTrackingProperty()', () => {
        ...
        beforeEach(() => {
            ...
            getTrackingValueMock = jest.spyOn(doPluginsGlobal.setArticleViewType, 'getTrackingValue').mockReturnValue('');
        ...
        it('it should return the right event name if tracking value is of type: Dark Social', () => {
            const result = doPluginsGlobal.setArticleViewType.getViewTypeByTrackingProperty();
        ...
        it('it should return the right event name if tracking value is of type: Other Internal', () => {
            ...
            let result = doPluginsGlobal.setArticleViewType.getViewTypeByTrackingProperty();
            expect(result).toBe('event23');

            getTrackingValueMock.mockReturnValue('affiliate');
            result = doPluginsGlobal.setArticleViewType.getViewTypeByTrackingProperty();
            expect(result).toBe('event23');
        });
    });
