...
describe('tracking Value (URL Parameter like cid)', () => {
    let s;
    let addEventMock;
    ...
    it('should not set event49 if the trackingValue does not contain kooperation.article.outbrain', () => {
    ...
    it('should not set event49 if the trackingValue does not contain kooperation.home.outbrain.', () => {
        getTrackingValueMock.mockReturnValue('any-trackingValue');
    ...
    //Upday
    it('should set event231 if the trackingValue equals cid=upday', () => {
        getTrackingValueMock.mockReturnValue('cid=upday');

        s._setTrackingValueEvents(s);
        expect(addEventMock).toHaveBeenCalledWith('event204');
    });
    it('should not set event49 if the trackingValue does not equals upday', () => {
        getTrackingValueMock.mockReturnValue('any-trackingValue');
    ...
    //Telegram
    it('should set event231 if the trackingValue contains .telegram.', () => {
